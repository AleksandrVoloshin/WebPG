...
public class StuffController extends HttpServlet {
    ...
    private void showEditForm(HttpServletRequest req, HttpServletResponse resp) throws SQLException, IOException, ServletException {
        ...
        RequestDispatcher dispatcher = req.getRequestDispatcher("WEB-INF/StuffForm.jsp");
    ...
    private void listStuff(HttpServletRequest req, HttpServletResponse resp) throws SQLException, IOException, ServletException {
        RequestDispatcher dispatcher = req.getRequestDispatcher("WEB-INF/StuffList.jsp");
